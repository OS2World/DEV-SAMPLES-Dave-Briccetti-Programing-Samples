:userdoc.
:title.Help for Air Traffic Control Container Version 3
:docprof.
:ctrldef.
...
:i1.Program Author
:p.:link reftype=fn refid=db.Dave Briccetti Software Consulting:elink.
.br
P.O. Box 1713
.br
...
:p.Copyright (c) 1993-1995, David C. Briccetti
.br
All Rights Reserved.

:fn id=db.
:p.Dave Briccetti Software Consulting
